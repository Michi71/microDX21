...
#ifndef _VELVETKEYS_H
#define _VELVETKEYS_H
...
public:
    ...
    void ForwardMIDI(const u8* msg, size_t len, CVelvetMIDIDevice* source);
    void HandleSysExFromDevice(const u8* msg, size_t len, CVelvetMIDIDevice* source);

    // Channel filter consulted by CVelvetMIDIDevice::HandleMIDI for
...
private:
    ...
    CVelvetUSBMIDIDevice*    m_usbMidi[MaxUSBMIDIDevices];
    CVelvetSerialMIDIDevice* m_serialMidi;
    CVelvetPCKeyboard*       m_pcKeyboard;
