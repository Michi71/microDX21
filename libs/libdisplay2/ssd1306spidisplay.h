#ifndef _display_ssd1306spidisplay_h
#define _display_ssd1306spidisplay_h
...
class CSSD1306SPIDisplay : public CDisplay
{
public:
...
public:
    CSSD1306SPIDisplay(CSPIMaster *pSPIMaster,
